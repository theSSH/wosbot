...
public enum TemplatesEnum {
    ...
    GAME_HOME_SHORTCUTS_HELP_REQUEST2, GAME_HOME_SHORTCUTS_HELP_REQUEST3, GAME_HOME_SHORTCUTS_UPGRADE, GAME_HOME_SHORTCUTS_OBTAIN, GAME_HOME_SHORTCUTS_ATTACK,
    ...
    ARENA_GEMS_EXTRA_ATTEMPTS_BUTTON, ARENA_VICTORY, GAME_HOME_CAMP_TRAIN, TRAINING_TRAIN_BUTTON, TRAINING_REPLENISH_ALL, TROOPS_ALREADY_MARCHING,
    RALLY_BUTTON, RALLY_REMOVE_HERO_BUTTON, RALLY_EQUALIZE_BUTTON, RALLY_HOLD_BUTTON, RALLY_LOCKED_FLAG_SLOT,
    MARCH_QUEUE_RETURNING_ICON,
    ...
    EXPLORATION_CLAIM, EXPLORATION_BUTTON, EXPLORATION_VICTORY, EXPLORATION_DEFEAT, HERO_RECRUIT_CLAIM,
